...
const PLATFORM_META: Record<PlatformKey, { label: string; color: string; render: () => JSX.Element }> = {
  ...
  tiktok: {
    label: 'TikTok',
    // The pricing page uses a dark icon tile. Black TikTok artwork therefore
    // rendered as a blank black square; use the white-on-dark brand treatment.
    color: '#FFFFFF',
    render: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
const plans: Plan[] = [
  {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { text: '3 posts/mes · TikTok', included: true },
        ],
      },
    ],
  },
  {
    ...
    groups: [
      ...
      },
      {
        title: 'SOCIAL POSTING',
        items: [
          { text: '15 posts/mes · Todas las redes', included: true },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    rows: [
      { label: 'Publicaciones / mes', values: ['3', '15', '50', 'Ilimitado'] },
      {
        label: 'Publica en',
        values: [
          { kind: 'platforms', keys: ['tiktok'] },
          { kind: 'platforms', keys: ['tiktok', 'facebook', 'instagram', 'linkedin', 'x', 'youtube'] },
          { kind: 'platforms', keys: ['tiktok', 'facebook', 'instagram', 'linkedin', 'x', 'youtube'] },
          { kind: 'platforms', keys: ['tiktok', 'facebook', 'instagram', 'linkedin', 'x', 'youtube'] },
        ],
      },
