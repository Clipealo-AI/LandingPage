...
export const featurePages: FeaturePageData[] = [
  ...
  },
  {
    ...
    metaDescription:
      "Descarga todos los clips de un proyecto en un solo clic. Ahorra horas de trabajo al gestionar múltiples videos o clientes. Para agencias y cliperos en LATAM.",
    h1: "Exportación en masa: entrega todos tus clips en un solo clic",
    intro:
      "Con Clipealo no necesitas descargar clip por clip. Procesa tu video y descarga todos los clips en formato vertical 9:16 con un solo clic. Ideal para agencias que manejan múltiples clientes y cliperos que producen alto volumen de contenido semanalmente.",
    sections: [
      {
        heading: "Cómo funciona la exportación en masa en Clipealo",
        content:
          "Después de que Clipealo genera los clips, puedes descargarlos todos con un solo clic usando la función de exportación en masa.\n\nEl proceso es simple:\n1. Abre el proyecto con los clips generados\n2. Selecciona los clips que quieres descargar (o selecciónalos todos)\n3. Descarga un archivo ZIP con tus clips organizados en formato vertical 9:16\n\nCada clip incluye subtítulos y el estilo que hayas configurado, listo para publicar en redes sociales.",
      },
      {
        heading: "Cuánto tiempo ahorras frente a la descarga individual",
        content:
          "Descargar clips uno por uno toma entre 30 y 45 segundos por clip: seleccionar, esperar la preparación, descargar y renombrar. Para 10 clips, son de 5 a 8 minutos de trabajo repetitivo.\n\nCon exportación en masa, el mismo proceso toma menos de 30 segundos: un clic y todos los clips se descargan organizados.\n\nPero el ahorro real se nota a escala. Para un clipero que procesa 5 videos por semana (50 clips), la descarga individual consume 40 minutos semanales en una tarea puramente mecánica. Con exportación en masa, ese tiempo se reduce a 3 minutos.\n\nPara agencias con 5 clientes y 2 videos semanales por cliente (100 clips/semana), el ahorro semanal es de más de 1 hora solo en descargas.",
      },
      {
        heading: "Formato disponible: vertical 9:16",
        content:
          "Todos los clips se exportan en formato vertical 9:16, preparado para publicar en TikTok, Instagram Reels, YouTube Shorts y otras redes compatibles. El reencuadre automático mantiene al hablante dentro del encuadre y posiciona los subtítulos en una zona legible.",
      },
      {
        heading: "Cómo organizar tus clips antes de exportar",
        content:
          "Antes de exportar, Clipealo te permite organizar tus clips de varias formas:\n\n- **Por score de viralidad:** Ordena los clips del más viral al menos viral para priorizar cuáles publicar primero.\n- **Por duración:** Agrupa clips cortos (30s) para TikTok y más largos (60-90s) para Reels y Shorts.\n- **Selección manual:** Elige solo los clips que quieres exportar y descarta el resto.\n\nEsta organización previa te permite entregar a tu cliente exactamente lo que necesita, sin clips innecesarios, y programar la publicación de forma estratégica.",
      },
      {
        heading:
          "Casos de uso: agencias con múltiples clientes y cliperos de alto volumen",
        content:
          "**Agencias con 5+ clientes:** Cada cliente tiene su propio proyecto en Clipealo. Cuando procesas un video, exportas todos los clips como archivo ZIP con el branding de ese cliente.\n\n**Cliperos que producen clips cada semana:** La exportación en masa descarga varios clips juntos para que puedas dedicar más tiempo al criterio creativo.\n\n**Equipos de marketing que publican en múltiples redes:** Preparan clips en formato vertical 9:16 para compartir en sus plataformas.\n\n**Social media managers:** Reciben los clips organizados y los suben a sus herramientas de programación.",
      },
      {
        heading: "Exportación en masa vs descarga manual: comparativa real",
        content:
          "**Descarga manual (10 clips):**\n- Seleccionar cada clip: 10 clics\n- Esperar preparación individual: 30s × 10 = 5 minutos\n- Renombrar archivos: 2 minutos\n- Organizar en carpetas: 3 minutos\n- **Total: ~10 minutos por proyecto**\n\n**Exportación en masa (10 clips):**\n- Seleccionar todos: 1 clic\n- Descargar ZIP: 30 segundos\n- **Total: ~30 segundos por proyecto**\n\nMultiplicado por 5 proyectos semanales, la diferencia es de 50 minutos vs 2.5 minutos. A lo largo de un mes, son más de 3 horas recuperadas en una tarea que no agrega ningún valor creativo.",
      },
    ],
    faqs: [
      {
        question: "¿Puedo exportar clips de diferentes proyectos a la vez?",
        answer:
          "Actualmente la exportación en masa funciona por proyecto. Puedes exportar todos los clips de un proyecto con un clic.",
      },
      {
        question: "¿En qué formatos se exportan los clips?",
        answer: "En MP4 y formato vertical 9:16, listo para publicar en redes sociales.",
      },
      {
        question: "¿Los subtítulos y estilos se mantienen en la exportación?",
        answer:
          "Sí. Los subtítulos, estilos y plantillas de marca se integran directamente en el video exportado.",
      },
      {
        question: "¿Hay límite de clips por exportación?",
        answer: "No. Puedes exportar todos los clips de un proyecto sin límite.",
      },
      {
        question: "¿Cuánto cuesta el plan que incluye exportación en masa?",
        answer:
          "La exportación en masa está disponible en todos los planes. Consulta la página de precios.",
      },
    ],
    internalLinks: [
      { label: "Ver precios de Clipealo", href: "/precios" },
      {
        label: "Gestión de proyectos y carpetas",
  ...
  },
  {
    ...
    metaTitle: "Exportación vertical 9:16 — Clipealo",
    metaDescription:
      "Prepara clips verticales 9:16 con reencuadre automático, subtítulos y estilos listos para publicar en tus redes.",
    h1: "Exporta clips verticales en 9:16 para todas tus redes",
    intro:
      "Clipealo convierte los mejores momentos de tus videos en clips verticales 9:16, con reencuadre automático y subtítulos listos para publicar. El formato se mantiene consistente en cada red y permite adaptar el contenido original al video corto.",
    sections: [
      {
        heading: "Un formato vertical para publicar en tus redes",
        content:
          "Clipealo exporta los clips en formato vertical 9:16, el formato que utiliza para publicaciones de video corto. Puedes preparar clips para TikTok, Instagram Reels, YouTube Shorts y otros destinos compatibles desde el mismo proyecto.\n\nEl video original puede tener otra proporción: el reencuadre automático selecciona la zona de interés y la adapta al lienzo vertical. Así, no necesitas crear versiones adicionales en otros formatos.",
      },
      {
        heading: "Cómo funciona el reencuadre automático de Clipealo",
        content:
          "Cuando Clipealo genera un clip en formato 9:16 a partir de un video 16:9, la IA realiza un reencuadre inteligente:\n\n1. **Detecta al hablante principal:** Identifica la posición del speaker en cada frame\n2. **Centra el encuadre:** Mantiene al hablante centrado en el formato vertical\n3. **Sigue el movimiento:** Si el hablante se mueve, el encuadre lo sigue suavemente\n4. **Posiciona los subtítulos:** Los coloca en la zona óptima del formato vertical\n\nEl resultado es un clip vertical que se ve como si hubiera sido grabado en vertical, no como un recorte mecánico de un video horizontal. El hablante siempre está en el centro, los subtítulos son legibles y la composición visual es profesional.\n\nTodo esto ocurre automáticamente durante los 5 minutos de procesamiento. No necesitas ajustar nada manualmente.",
      },
      {
        heading: "Reencuadre automático desde el video original",
        content:
          "Cuando el video original es horizontal, Clipealo adapta el contenido al lienzo vertical 9:16:\n\n1. **Detecta al hablante principal:** identifica su posición en cada escena.\n2. **Centra el encuadre:** mantiene a la persona o el momento relevante dentro del clip.\n3. **Sigue el movimiento:** ajusta el recorte mientras cambia la escena.\n4. **Posiciona los subtítulos:** los mantiene en una zona legible del formato vertical.\n\nEl formato de origen no determina el formato de publicación: los clips exportados quedan en 9:16.",
      },
      {
        heading: "9:16 para TikTok, Reels y Shorts: cuándo y cómo usarlo",
        content:
          "El formato 9:16 es obligatorio para:\n\n- **TikTok:** La plataforma de video corto más importante para descubrimiento orgánico. Los videos verticales reciben 3x más distribución que los horizontales.\n- **Instagram Reels:** El formato de mayor alcance en Instagram. Los Reels verticales dominan el Explore y el feed.\n- **YouTube Shorts:** El formato de video corto de YouTube con distribución masiva en la pestaña Shorts.\n\nClipealo genera clips verticales con reencuadre automático inteligente. El hablante siempre está centrado, los subtítulos se posicionan en la zona inferior y la composición visual es profesional.\n\nPara cliperos y agencias que publican en las 3 plataformas, tener la versión 9:16 lista automáticamente ahorra 15-20 minutos de reencuadre manual por clip.",
      },
      {
        heading: "Reencuadra tus clips sin editar cada toma a mano",
        content:
          "Clipealo prepara cada exportación en 9:16 y coloca los subtítulos en el lienzo vertical. Revisa el resultado, ajusta el encuadre si hace falta y descarga los clips desde el proyecto.\n\nEl mismo formato se aplica a todos los destinos de publicación disponibles, por lo que puedes concentrarte en elegir los momentos y preparar cada clip.",
      },
      {
        heading: "Para quién es ideal: cliperos, agencias y creadores multiplataforma",
        content:
          "**Cliperos profesionales:** preparan clips verticales para las cuentas de sus creadores.\n\n**Agencias de contenido:** mantienen un formato de entrega consistente entre clientes.\n\n**Creadores multiplataforma:** reutilizan sus videos en distintas redes sin preparar varias proporciones.\n\n**Equipos de marketing:** convierten webinars y presentaciones en clips verticales listos para redes.\n\nClipealo genera clips en 9:16. Consulta la página de precios para ver los planes disponibles.",
      },
    ],
    faqs: [
      {
        question: "¿Qué formato tienen los clips exportados?",
        answer: "Los clips se exportan en formato vertical 9:16.",
      },
      {
        question:
          "¿El reencuadre automático funciona bien con múltiples personas en pantalla?",
        answer:
          "La IA detecta al hablante principal y centra el encuadre en él. Funciona mejor con 1-2 personas en pantalla.",
      },
      {
        question: "¿Puedo ajustar manualmente el encuadre si la IA no lo hace bien?",
        answer:
          "Sí. Puedes modificar el punto de enfoque del reencuadre antes de exportar.",
      },
      {
        question: "¿Los subtítulos se adaptan al formato automáticamente?",
        answer:
          "Los subtítulos se ajustan al lienzo vertical 9:16 para mantenerlos legibles en el clip exportado.",
      },
      {
        question: "¿En qué plan está disponible?",
        answer:
          "Consulta la página de precios para conocer las funciones incluidas en cada plan.",
      },
    ],
    internalLinks: [
      { label: "Ver precios de Clipealo", href: "/precios" },
